...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20250117_real_estate_f915a8abf2abf1852195_20250117133541_archive.zip';
        const ARCHIVE_SIZE       = '49886252';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'f915a8a-17133541';
        const SECONDARY_PACKAGE_HASH = '18c9eb6-17133541';
